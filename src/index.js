...
$(document).ready(function(){
	...
	var segments = [
		...
		new SegmentViewModel(14120182, 'Radio Tower Climb', 'W', 0.6, 14),
		new SegmentViewModel(14270131, 'Volcano KOM', 'W', 2.3, 3, 'volcano-jersey'),
	...
	var routes = [
        ...
        new SegmentViewModel(14032406, 'Volcano Circuit Forward', 'W', 2.5, 0, 'volcano-jersey'),
        new SegmentViewModel(14032426, 'Volcano Circuit Reverse', 'W', 2.5, 0, 'volcano-jersey'),
        new SegmentViewModel(14032442, 'Volcano Flat Forward', 'W', 7.6, 0),
		new SegmentViewModel(14120237, 'Volcano Flat Reverse', 'W', 7.6, 0),
